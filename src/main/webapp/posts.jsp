    ...
    <c:if test="${sessionScope.user.user_id gt 0}">
        <figure>
            <table>
                ...
                <tr>
                    <td><strong>HEY!</strong></td>
                    <td><em><a href="${pageContext.request.contextPath}/UserServer?op=createNewBlog" class="headline-description" >${sessionScope.user.username}, Why not create your own blog now? </a></em></td>
                </tr>
                </tbody>
            </table>
        </figure>
